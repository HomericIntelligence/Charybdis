...
The `integration-tests` context intentionally appears in both the required
fan-in workflow and the dedicated integration workflow. Both carriers must
complete successfully. The release publisher remains tag/manual-only and must
